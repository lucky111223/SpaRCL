...
def ICP_align(adata_concat, adata_target, adata_ref, slice_target, slice_ref, landmark_domain, plot_align=False):
    ...
    mnn_dict = create_dictionary_mnn(batch_pair, use_rep='SpaRCL', batch_name='batch_name', k=1, iter_comb=None, verbose=0)
    ...
    anchor_arr = adata_concat.obsm['SpaRCL'][anchor_ind, ]
    positive_arr = adata_concat.obsm['SpaRCL'][positive_ind, ]
